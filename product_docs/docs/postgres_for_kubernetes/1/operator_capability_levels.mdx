...
By default, EDB Postgres for Kubernetes creates three Kubernetes [services](service_management.md)
...
and multi-cloud deployments. With EDB Postgres for Kubernetes, you gain powerful capabilities,
including:
...
EDB Postgres for Kubernetes, ensuring robust data integrity and continuity across diverse
environments.
